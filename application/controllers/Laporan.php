...
class Laporan extends CI_Controller
{
    ...
    {
        if (!$this->session->userdata('isLogin') || $this->session->userdata('hak_akses') != 'kepala') {
            redirect(base_url());
        }
        $data['title']   = 'Laporan';
    ...
    public function kembali($id = '')
    {
        ...
        if ($id !== '') {
            ...
            $data['judul_laporan'] = "Laporan Transaksi - " . $data['transaksi']['nama_member'];
    ...
    public function laporanuser($id = '')
    {
        ...
        if ($id !== '') {
            ...
            $user   = $this->db->get_where('member', ['no_reg' => $no_reg])->row_array();
            $data['transaksi']     = $this->m_transaksi->getById($id);
            $data['judul_laporan'] = "Laporan Transaksi - " . $user['nama_member'];
