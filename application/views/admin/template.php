...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <?php if ($this->session->userdata('hak_akses') == 'admin') : ?>
                        ...
                        <li class="treeview <?= ($title == 'Buku' || $title == 'Member' || $title == 'Admin List') ? 'active' : '' ?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?= ($title == 'Member') ? 'active' : '' ?>"><a href="<?= base_url('member') ?>"><i class="fa fa-circle-o"></i> Member</a></li>
        ...
        <footer class="main-footer">
            ...
            cw<strong>Copyright &copy; <?= date('Y') ?> <a href="">Ferdy Wildan P</a>.</strong> All rights
            reserved.
        </footer>
    </div>
