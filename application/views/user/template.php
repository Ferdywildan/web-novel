    ...
    <div class="wrapper">
            ...
            <nav class="navbar navbar-static-top ">
                <div class="container">
                    <div class="navbar-header">
                        <a href="<?= base_url(); ?>" class="navbar-brand" style="margin-left: 0">Pustaka Novel</a>
        ...
        <footer class="main-footer">
            <div class="container">
                ...
                <strong>Copyright &copy; 2022 <a href=" <?= base_url('home') ?>">Pustaka Novel</a>.</strong> All rights
                reserved.
            </div>
            <!-- /.container -->
        </footer>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Detail Novel</h4>
                </div>
                            ...
                            <div class="col-md-7">
                                ...
                                <?php if (!$this->session->userdata('isLogin')) : ?>
                                    <div class="alert alert-danger alert-dismissible">
                                        ...
                                        <h4><i class="icon fa fa-danger"></i> Peringatan!</h4>
